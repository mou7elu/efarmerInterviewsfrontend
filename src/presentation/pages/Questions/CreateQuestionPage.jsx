 ...
 * Formulaire de création d'une question avec tous les champs du modèle
 */
...
const CreateQuestionPage = () => {
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        // Charger sections et volets en parallèle
        ...
        setError('Erreur lors du chargement des sections et volets');
      }
    };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate('/questions', { state: { message: 'Question créée avec succès' } });
    } catch (err) {
  ...
  return (
    <Container maxWidth="md">
      <Box mb={4}>
        <Typography variant="h4">Créer une nouvelle question</Typography>
        <Typography variant="body2" color="text.secondary">
          Remplir tous les champs requis pour créer la question
        </Typography>
      </Box>
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} display="flex" justifyContent="flex-end" gap={2} mt={2}>
              ...
              <Button 
                ...
                disabled={isLoading}
              >
                {isLoading ? 'Enregistrement...' : 'Créer la question'}
              </Button>
            </Grid>
          </Grid>
        </Box>
